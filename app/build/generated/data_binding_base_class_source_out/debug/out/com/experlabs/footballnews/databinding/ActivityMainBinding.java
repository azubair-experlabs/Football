...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull ConstraintLayout container,
      @NonNull NavigationView drawerNav, @NonNull DrawerLayout myDrawerLayout,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, container, drawerNav, myDrawerLayout,
          navView);
    }
